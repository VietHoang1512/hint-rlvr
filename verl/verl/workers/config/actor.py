...
class ActorConfig(BaseConfig):
    ...
    use_sft: Optional[bool] = False
    use_full_solution_hint: bool = False
    reprompt_template: str = (
        "{prompt}{solution}{feedback}\n"
        "Write a new standalone solution to the original question without mentioning the previous reference, feedback.\n"
    )
    ...
    feedback_template: str = (
        ...
        "Previous response:\n"
        "{response}\n"
        "Feedback for your previous response:\n"
        "{feedback}"
    )
